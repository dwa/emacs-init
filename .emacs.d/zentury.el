;;
;; handy tool to test new color schemes:
;; 
;; (custom-set-faces '(wl-highlight-message-headers ((t (:foreground "DarkGray"
;; :bold nil))) t))
...
(defun color-theme-zentury ()
  "Color theme by david, created 2005-05-28."
  (interactive)
  (color-theme-install
   '(color-theme-zentury
...
;      (cursor-color . "orange2")
     ...
     ((apropos-keybinding-face . underline)
      ...
      (whizzy-error-face . whizzy-error-face)
      (whizzy-slice-face . whizzy-slice-face)
      (widget-mouse-face . highlight))
     (default ((t (:stipple nil :background "Grey15" :foreground "Grey" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 96 :width semi-condensed :family "misc-fixed"))))
     ...
     (completions-common-part ((t (:family "misc-fixed" :width semi-condensed :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "Grey" :background "Grey15" :stipple nil :height 96))))
     ...
     (darcsum-marked-face ((t (:background "#332323" :foreground "#e37170"))))
...
;     (dired-face-marked ((t (:foreground "light salmon"))))
     ...
     (dired-marked ((t (:background "#332323" :foreground "#e37170"))))
...
;     (erc-error-face ((t (:bold t :foreground "IndianRed" :weight bold))))
     (erc-error-face ((t (:bold t :foreground "OrangeRed" :weight bold))))
...
;     (erc-nick-default-face ((t (:bold t :weight bold))))
     (erc-nick-default-face ((t (:foreground "DarkSeaGreen4" :bold t :weight bold))))
;     (erc-nick-msg-face ((t (:bold t :foreground "IndianRed" :weight bold))))
     (erc-nick-msg-face ((t (:bold t :foreground "OrangeRed" :weight bold))))
     (erc-notice-face ((t (:foreground "#878899"))))
;     (erc-notice-face ((t (:foreground "RosyBrown4"))))
...
;     (erc-timestamp-face ((t (:bold nil :foreground "pale turquoise" :weight normal))))
     (erc-timestamp-face ((t (:bold nil :foreground "gray45" :weight normal))))
     (erc-underline-face ((t (:underline t))))
;     (escape-glyph ((t (:foreground "cyan"))))
     (escape-glyph ((t (:foreground "gray31"))))
     (eshell-ls-archive-face ((t (:bold t :foreground "medium purple" :weight bold))))
     (eshell-ls-backup-face ((t (:foreground "gray27"))))
...
;     (eshell-prompt-face ((t (:bold t :foreground "light sky blue" :weight bold))))
     (eshell-prompt ((t (:bold t :foreground "DarkSeaGreen4" :weight bold))))
     (eshell-prompt-face ((t (:bold t :foreground "GoldenRod3" :weight bold))))
...
;     (font-lock-builtin-face ((t (:foreground "PaleGreen4"))))
;     (font-lock-builtin-face ((t (:foreground "thistle4"))))
;     (font-lock-builtin-face ((t (:foreground "GoldenRod4"))))
;     (font-lock-builtin-face ((t (:foreground "DimGray"))))
     (font-lock-builtin-face ((t (:foreground "gray55"))))
     (font-lock-comment-face ((t (:foreground "DarkSeaGreen4"))))
;     (font-lock-comment-face ((t (:foreground "plum4"))))
;     (font-lock-constant-face ((t (:foreground "pale green"))))
     (font-lock-constant-face ((t (:foreground "DarkSlateGray3"))))
...
;     (font-lock-doc-string-face ((t (:foreground "PaleVioletRed3"))))
;     (font-lock-function-name-face ((t (:bold t :foreground "aquamarine" :weight bold))))

;     (font-lock-function-name-face ((t (:foreground "DeepPink4"))))
     (font-lock-function-name-face ((t (:foreground "IndianRed"))))
;     (font-lock-keyword-face ((t (:bold t :foreground "pale turquoise" :weight bold))))
;     (font-lock-keyword-face ((t (:foreground "DimGray"))))
;     (font-lock-keyword-face ((t (:foreground "GoldenRod4"))))
     (font-lock-keyword-face ((t (:foreground "LightSkyBlue4"))))
     (font-lock-preprocessor-face ((t (:foreground "aquamarine"))))
;     (font-lock-preprocessor-face ((t (:foreground "PaleVioletRed3"))))
;     (font-lock-reference-face ((t (:foreground "pale green"))))
     (font-lock-reference-face ((t (:foreground "PaleVioletRed3"))))
...
;     (font-lock-type-face ((t (:bold t :foreground "sky blue" :weight bold))))
     (font-lock-type-face ((t (:foreground "GoldenRod3"))))
;     (font-lock-type-face ((t (:foreground "DimGray"))))
;     (font-lock-variable-name-face ((t (:bold t :foreground "turquoise" :weight bold))))
;     (font-lock-variable-name-face ((t (:foreground "IndianRed3"))))
...
;     (highlight ((t (:background "dark slate blue" :foreground "light blue"))))
     ...
     (longlines-visible-face ((t (:background "red"))))
...
;     (minibuffer-prompt ((t (:foreground "cyan"))))
     (minibuffer-prompt ((t (:foreground "IndianRed3"))))
...
;     (mode-line-inactive ((t (:background "grey30" :foreground "grey80" :box (:line-width -1 :color "grey40" :style nil) :weight light))))
     (mode-line-inactive ((t (:background "gray24" :foreground "gray58"
					  :box (:color "gray24" :line-width 2)))))
     (mode-line ((t (:background "#2e3330" :foreground "#88b090"
				 :box (:color "#2e3330" :line-width 2)))))
     (mouse ((t (:background "Grey"))))

     (mumamo-background-chunk-major ((t (:background "Grey20"))))
     (mumamo-background-chunk-submode ((t (:background "Grey25"))))


     (nethack-map-tile-face ((t (:inherit :default))))
;;      (nethack-orange-face ((t (:foreground "pale green"))))
;;      (nethack-red-face ((t (:foreground "pale green"))))
     ...
     (outline-4 ((t (:foreground "aquamarine"))))
     (outline-5 ((t (:foreground "light blue"))))
     (outline-6 ((t (:foreground "pale green"))))
     (outline-7 ((t (:bold t :weight bold :foreground "sky blue"))))
     (outline-8 ((t (:foreground "light sky blue"))))
     (query-replace ((t (:background "slate blue"))))
;     (region ((t (:background "DarkSlateBlue"))))
     (region ((t (:background "grey28"))))
...
;     (show-paren-match-face ((t (:background "light slate blue" :foreground "white"))))
     (show-paren-match-face ((t (:background "DarkSeaGreen4" :foreground "white"))))
     ...
     (slime-highlight-edits-face ((t (:background "gray21"))))
     (slime-display-edit-face ((t (:background "gray21"))))
...
;     (slime-repl-output-face ((t (:foreground "pink"))))
;     (slime-repl-output-face ((t (:foreground "#6BF59CDAA21C"))))
     (slime-repl-output-face ((t (:foreground "#98878C0F7BF6"))))
     (slime-repl-prompt-face ((t (:bold t :weight bold :foreground "DarkSeaGreen4"))))
;     (slime-repl-prompt-face ((t (:bold t :weight bold :foreground "pale turquoise"))))
     ...
     (todoo-item-assigned-header-face ((t (:bold t :foreground "red" :weight bold))))
     (todoo-item-header-face ((t (:bold t :foreground "goldenrod" :weight bold))))
     ...
     (whizzy-error-face ((t (:background "Khaki"))))
     (whizzy-slice-face ((t (nil))))
     ...
     (wl-highlight-message-headers ((t (:foreground "DarkGray"))) t)
     (wl-highlight-message-header-contents ((t (:foreground "LightBlue"))) t)
     (wl-highlight-message-important-header-contents ((t (:foreground "Yellow"))) t)
     (wl-highlight-message-important-header-contents2 ((t (:foreground "Orange"))) t)
     (wl-highlight-message-unimportant-header-contents ((t (:foreground "DarkSeaGreen4"))) t)
     (wl-highlight-folder-zero-face ((t (:foreground "grey68"))))
     (wl-highlight-folder-many-face ((t (:foreground "#e37170"))))
     (wl-highlight-folder-unread-face ((t (:foreground "#88b090"))))
     (wl-highlight-folder-unknown-face ((t (:foreground "Goldenrod3"))))
...
(defalias 'zentury #'color-theme-zentury)
