...
;; Another use would be "templates". By defining the following template, you can
;; use /foo to save you some typing:
...
;; It is also easy to implement new ERC aliases entirely in Emacs Lisp. For
;; example, here's a /WII alias, which can save you a lot of typing if you find
;; yourself often typing /WHOIS with two arguments (i.e. to see idle information
;; about a connected IRC user):
